...
public class AnimatedMovie extends MovieRental {
    public String movie;
    ...
    public int quantity;
    public String genre;
    public AnimatedMovie(int sno,String movie, String director, int year, double imdb, int price,int quantity,String genre) {
        this.sno=sno;
        this.movie = movie;
